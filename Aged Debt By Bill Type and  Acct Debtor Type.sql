...
SELECT  
    ...
    'Month'              = st.month,
    'Bill Type'          = st.bill_type_desc,
    'Acct Debtor Type'   = st.acct_deb_type_desc,
...
GROUP BY st.fk_financial_year, st.month, st.bill_type_desc, st.acct_deb_type_desc
ORDER BY st.bill_type_desc, st.acct_deb_type_desc
